...
s = Solution()
print(s.countValidWords(sentence="cat and  dog"))
print(s.countValidWords(sentence="!this  1-s b8d!"))
print(s.countValidWords(sentence="alice and  bob are playing stone-game10"))
print(s.countValidWords(sentence="alice and  bob are playing stone-game"))
print(s.countValidWords(sentence="ab, cd! . a!b c., a-b. afad ba-c a! !"))
